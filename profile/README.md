...
1. **Governance, Accountability & Representation:**
...
|----------|--------------|---------------|---------|----------|
| Team Meeting | Highland Hall, UTSC | TBD | TBD | Bi-weekly |
| Writing/Coding Days | Highland Hall, UTSC | Wednesday | 9AM-5PM | Weekly | 
...
Special thanks to [Rohan Alexander](https://github.com/RohanAlexander) and the [Data Sciences Institute at the University of Toronto](https://github.com/UofT-DSI) for the README.md layout and repository structure.
